...
This project is indexed by GitNexus as **llama.cpp** (60757 symbols, 114667 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
